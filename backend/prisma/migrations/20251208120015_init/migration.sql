...
CREATE TABLE "StoreSettings" (
    ...
    "logo" TEXT,
    "favicon" TEXT,
    "primaryColor" TEXT NOT NULL DEFAULT '#FF6B6B',
    "secondaryColor" TEXT NOT NULL DEFAULT '#4ECDC4',
    "currency" TEXT NOT NULL DEFAULT 'USD',
    "currencySymbol" TEXT NOT NULL DEFAULT '$',
    "defaultTaxRate" DECIMAL(5,2) NOT NULL DEFAULT 0,
    "shippingRate" DECIMAL(10,2) NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "PolicyPage_slug_idx" ON "PolicyPage"("slug");

-- CreateIndex
CREATE INDEX "Metafield_productId_idx" ON "Metafield"("productId");

-- CreateIndex
CREATE UNIQUE INDEX "Metafield_productId_namespace_key_key" ON "Metafield"("productId", "namespace", "key");
